...
const CourierDetails =   async(req, res) => {
    ...
    try {
        ...
        var sql = `select "U_Voucher","U_VouchrDte","U_CardCode","U_CardName","U_ItemCode","U_CusPo","U_SaleNo","U_ItemShort",
        "U_Quantity","U_Docket","U_CourName","U_BillNo","U_Remarks" from  ${DbName}."@INSY_CDTL1" where "U_CardCode"='${req.params.id}'`;
    }
    }
